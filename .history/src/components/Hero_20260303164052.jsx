  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="hero-content">
        ...
        <p className="hero-title">Frontend Developer & Creative Thinker</p>
        <p className="hero-desc">
          I craft beautiful, interactive web experiences with a love for clean
          code and soft aesthetics. ✦
        </p>
